...
//         short_desc: 'Khóa học thực chiến Javascript nâng cao, ES6, JSON, API và React JS.',
//         slug: 'cfd4-react-js',
//         title: 'CFD4 React JS',
...
//         short_desc: 'Khóa học thực chiến dự án thực tế gồm Javascript nâng cao, ES6, JSON, API và React JS.',
//         slug: 'cfd2-react-js',
//         title: 'CFD2 React JS',
//         thumbnailUrl: 'https://cfdcircle.vn/files/thumbnails/ZUTudJyluuW4DGhZ6iXS2z6jRnEe7RnKTKhDTR6h.jpg',
//     },
...
//         long_desc:
//             'Nếu bạn đã có kiến thức cơ bản về lập trình website responsive hoặc đã học qua khóa CFD Căn Bản. Bạn muốn nâng cao kiến thức và có nhiều cơ hội để ứng tuyển hơn vào vị trí Front-End Developer thì React Js chính là thư viện javascript được quan tâm nhất hiện nay. Khóa React Js tại CFD sẽ hướng dẫn bạn có được kiến thức và kỹ năng quan trọng dựa trên thực hành dự án thực tế xuyên suốt khóa học.',
//         short_desc: 'Khóa học thực chiến Javascript, ES6, JSON, API và React JS, Redux.',
//         slug: 'cfd5-react-js',
//         title: 'CFD5 React JS',
//         thumbnailUrl: 'https://cfdcircle.vn/files/thumbnails/ZUTudJyluuW4DGhZ6iXS2z6jRnEe7RnKTKhDTR6h.jpg',
//     },
...
import { api, COURSES_API } from '../config/api';

export const courseService = {
    getCourse(query = '') {
        return api.get(`${COURSES_API}courses${query}`);
    },
    getCourseDetail(id) {
        // return courses.find((item) => item.id === id);
        return api.get(`${COURSES_API}courses/${id}`);
    },
};
